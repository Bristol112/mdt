    ...
    <body>
        ...
        <main role="main" class="container">
            <div class="content-introduction">
                <h3>Liberate the car</h3>
                <p class="lead">Here you can modify the car.<br />You can add a note to the vehicle here. You can also recognize a vehicle.</p>
            </div>
                ...
                <?php if ($_SERVER['REQUEST_METHOD'] == "POST" && $_POST['type'] == "edit") { ?>
                    <form method="post">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-police">Edit Vehicle</button>
                        </div>
                    </form>
                <?php } ?>
                </div>

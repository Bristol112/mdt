    ...
    <body>
        ...
        <main role="main" class="container">
            <div class="content-introduction">
                ...
                <p class="lead">Here you create a profile when a new criminal is brought in.. <br /> Make sure all information is correct and that the correct photo is posted!</p>
            </div>
            ...
            <?php if ($_SERVER['REQUEST_METHOD'] == "POST" && $_POST['type'] == "edit" && !empty($selectedprofile)) { ?>
                <form method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="citizenid" class="form-control login-user" value="<?php echo $selectedprofile["citizenid"]; ?>" placeholder="CSN (find it in ID at first) (it might be empty)" required>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="avatar" class="form-control login-user" value="<?php echo $selectedprofile["avatar"]; ?>" placeholder="Image must be from this website (imgur URL e.g. https://imgur.com/)" required>
                    </div>
                    <div class="input-group mb-3">
                    ...
                    <div class="form-group">
                        <button type="submit" name="create" class="btn btn-primary btn-police">Save the modification</button>
                    </div>
                </form>
          <?php } else { ?>
                <form method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="citizenid" class="form-control login-user" value="" placeholder="CSN (find it in ID at first) (it might be empty)" required>
                    </div>
                    <div class="input-group mb-2">
                        <input type="text" name="fullname" class="form-control login-pass" value="" placeholder="Full name" required>
                    </div>
                    <div class="input-group mb-3">
                        <input type="text" name="avatar" class="form-control login-user" value="" placeholder="Image must be from this website (imgur URL e.g. https://imgur.com/)">
                    </div>
                    <div class="input-group mb-3">
                        <input type="text" name="fingerprint" class="form-control login-user" value="" placeholder="fingerprint">
                    </div>
                    <div class="input-group mb-3">
                        <input type="text" name="dnacode" class="form-control login-user" value="" placeholder="dnacode">
                    </div>
                    <div class="input-group mb-2">
